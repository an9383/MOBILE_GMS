...
{
    public class ProductEtcInService
    {
        static public ILogger<Controller> _logger;
        public BllSpExecute _bllSpExecute = new BllSpExecute();

        public ProductEtcInService(ILogger<Controller> logger)
        {
            _logger = logger;
        }

        public ProductModel ProductEtcInSearch(ProductModel model)
        {
            string SP_name = "SP_PDA_ProductEtcIn"; //  procedure 명 
        ...
        public string SaveProductEtcIn(ProductModel model)
        {
            string SP_name = "SP_PDA_ProductEtcIn"; // procedure 명 
            string gubun = "In"; // Gunbun 명
            string[] param = new string[6];
            param[0] = "@barcode_no:" + model.barcode;
            param[1] = "@in_type:" + model.in_type;
            param[2] = "@in_qty:" + model.in_qty;
            param[3] = "@in_date:" + model.in_date;
            param[4] = "@in_remark:" + model.in_remark;
