...
{
    public class StackStandbyService
    {
        static public ILogger<Controller> _logger;
        public BllSpExecute _bllSpExecute = new BllSpExecute();

        public StackStandbyService(ILogger<Controller> logger)
        {
            _logger = logger;
        }

        public List<StackStandbyModel> StackStandbySearch(StackStandbyModel model)
        {
