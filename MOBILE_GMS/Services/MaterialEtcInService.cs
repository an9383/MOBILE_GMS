...
{
    public class MaterialEtcInService
    {
        static public ILogger<Controller> _logger;
        public BllSpExecute _bllSpExecute = new BllSpExecute();

        public MaterialEtcInService(ILogger<Controller> logger)
        {
            _logger = logger;
        }

        public MaterialModel MaterialEtcInSearch(MaterialModel model)
        {
            string SP_name = "SP_PDA_MaterialEtcIn"; //  procedure 명 
        ...
        public string SaveMaterialEtcIn(MaterialModel model)
        {
            string SP_name = "SP_PDA_MaterialEtcIn"; // procedure 명 
            string gubun = "In"; // Gunbun 명
            ...
            param[3] = "@in_type:" + model.in_type;
            param[4] = "@in_qty:" + model.in_qty;
            param[5] = "@in_date:" + model.in_date;
            param[6] = "@in_remark:" + model.in_remark;
