...
{
    public class PDA_StockStatus2_M_TestController : Controller
    {
        static public ILogger<PDA_StockStatus2_M_TestController> _logger;

        public PDA_StockStatus2_M_TestController(ILogger<PDA_StockStatus2_M_TestController> logger)
        {
            _logger = logger;
        }
        ...
        {
            PDA_StockStatus2_M_TestService service = new PDA_StockStatus2_M_TestService(_logger);
