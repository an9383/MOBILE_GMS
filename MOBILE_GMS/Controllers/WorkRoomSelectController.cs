...
{
    public class WorkRoomSelectController : Controller
    {
        static public ILogger<WorkRoomSelectController> _logger;

        public WorkRoomSelectController(ILogger<WorkRoomSelectController> logger)
        {
            _logger = logger;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SelectWorkRoom([FromBody] WorkRoomSelectModel workRoomSelectModel)
        {
            WorkRoomSelectService service = new WorkRoomSelectService(_logger);
            WorkRoomSelectModel model = service.SelectZone(workRoomSelectModel);
