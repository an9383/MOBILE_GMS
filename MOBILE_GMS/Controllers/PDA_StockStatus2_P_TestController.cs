...
{
    public class PDA_StockStatus2_P_TestController : Controller
    {
        static public ILogger<PDA_StockStatus2_P_TestController> _logger;

        public PDA_StockStatus2_P_TestController(ILogger<PDA_StockStatus2_P_TestController> logger)
        {
            _logger = logger;
        }
        ...
        {
            PDA_StockStatus2_P_TestService service = new PDA_StockStatus2_P_TestService(_logger);
