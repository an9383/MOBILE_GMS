...
{
    public class MaterialPalletStackController : Controller
    {
        static public ILogger<MaterialPalletStackController> _logger;

        public MaterialPalletStackController(ILogger<MaterialPalletStackController> logger)
        {
            _logger = logger;
        }
