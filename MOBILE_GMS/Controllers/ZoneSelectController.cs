...
{
    public class ZoneSelectController : Controller
    {
        static public ILogger<ZoneSelectController> _logger;

        public ZoneSelectController(ILogger<ZoneSelectController> logger)
        {
            _logger = logger;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult SelectZone([FromBody] ZoneSelectModel zoneSelectModel)
        {
            ZoneSelectService service = new ZoneSelectService(_logger);
            ZoneSelectModel model = service.SelectZone(zoneSelectModel);
