...
{
    public class StackStandby3Controller : Controller
    {
        static public ILogger<StackStandby3Controller> _logger;

        public StackStandby3Controller(ILogger<StackStandby3Controller> logger)
        {
            _logger = logger;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult StackStandby3Search([FromBody] StackStandbyModel model)
        {
            StackStandby3Service service = new StackStandby3Service(_logger);
            List<StackStandbyModel> list = service.StackStandby3Search(model);
            return Json(list);
        }
