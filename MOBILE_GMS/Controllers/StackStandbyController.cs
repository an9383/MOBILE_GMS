...
{
    public class StackStandbyController : Controller
    {
        static public ILogger<StackStandbyController> _logger;

        public StackStandbyController(ILogger<StackStandbyController> logger)
        {
            _logger = logger;
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult StackStandbySearch([FromBody] StackStandbyModel model)
        {
            StackStandbyService service = new StackStandbyService(_logger);
            List<StackStandbyModel> list = service.StackStandbySearch(model);
            return Json(list);
        }
