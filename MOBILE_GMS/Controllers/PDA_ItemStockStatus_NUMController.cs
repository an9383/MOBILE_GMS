...
{
    public class PDA_ItemStockStatus_NUMController : Controller
    {
        static public ILogger<PDA_ItemStockStatus_NUMController> _logger;

        public PDA_ItemStockStatus_NUMController(ILogger<PDA_ItemStockStatus_NUMController> logger)
        {
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("_logger >> PDA_ItemStockStatus_NUMController Index() Access : " + DateTime.Now);
            /*
             * [중요]
        ...
        /// <returns></returns>
        [HttpPost]
        public JsonResult ItemStockStatus_Search([FromBody] ProductStockStatusModel model)
        {
            PDA_ItemStockStatus_NUMService service = new PDA_ItemStockStatus_NUMService(_logger);
            List<ProductStockStatusModel> list = service.ItemStockStatus_Search(model);
            return Json(list);
        }
