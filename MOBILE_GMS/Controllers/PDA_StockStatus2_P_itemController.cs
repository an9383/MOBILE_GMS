...
{
    public class PDA_StockStatus2_P_itemController : Controller
    {
        static public ILogger<PDA_StockStatus2_P_itemController> _logger;

        public PDA_StockStatus2_P_itemController(ILogger<PDA_StockStatus2_P_itemController> logger)
        {
            _logger = logger;
        }
        ...
        {
            _logger.LogInformation("_logger >> PDA_StockStatus2_P_itemController index() Access : " + DateTime.Now);
        ...
        {
            PDA_StockStatus2_P_itemService service = new PDA_StockStatus2_P_itemService(_logger);
